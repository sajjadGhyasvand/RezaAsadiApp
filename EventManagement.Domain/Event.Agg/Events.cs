...
namespace EventManagement.Domain.Event.Agg
{
    public class Events : EntityBase
    {
        ...
        public List<EventPicture.EventPicture> EventPictures { get; private set; }
        public Events(string title, string shortDescription, string description, string picture, 
            string pictureAlt, string pictureTitle, string slug, string metDescription, string keywords, 
            string canonicalAddress,DateTime publishDate, long languageId)
        {
            Title = title;
        ...
        public void Edit(string title, string shortDescription,
            ...
            string keywords, string canonicalAddress, DateTime publishDate, long languageId)
        {
            Title = title;
            ShortDescription = shortDescription;
            Description = description;
